namespace AstroRoutines.UnitTests
{
    public partial class SofaTests
    {
        ...
        public void TestPn00a()
        {
            ...
            Pn00a(2400000.5, 53736.0, out dpsi, out deps, out epsa, out rb, out rp, out rbp, out rn, out rbpn);
            ...
            Vvd(rn[1, 2], -0.4063240865362499850e-14, 1e-14, "Pn00a", "rn23", ref status);
            ...
            Vvd(rbpn[0, 1], -0.1332881761240011763e-14, 1e-14, "Pn00a", "rbpn12", ref status);
            Vvd(rbpn[0, 2], -0.5790767434730085751e-14, 1e-14, "Pn00a", "rbpn13", ref status);
            
            Vvd(rbpn[1, 0], 0.1332858254308954658e-14, 1e-14, "Pn00a", "rbpn21", ref status);
            Vvd(rbpn[1, 1], 0.9999991109044505577, 1e-12, "Pn00a", "rbpn22", ref status);
            Vvd(rbpn[1, 2], -0.4097782710396580452e-14, 1e-14, "Pn00a", "rbpn23", ref status);
            
            Vvd(rbpn[2, 0], 0.5791308472168152904e-14, 1e-14, "Pn00a", "rbpn31", ref status);
            Vvd(rbpn[2, 1], 0.4020595661591500259e-14, 1e-14, "Pn00a", "rbpn32", ref status);
