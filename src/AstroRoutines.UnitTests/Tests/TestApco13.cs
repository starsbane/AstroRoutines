...
namespace AstroRoutines.UnitTests
{
    public partial class SofaTests
    {
        ...
        public void TestApco13()
        {
            ...
            Vvd(astrom.bpn[0, 1], 0.4978650075315529277e-7, 1e-12, "Apco13", "bpn(1,2)", ref status);
            Vvd(astrom.bpn[0, 2], 0.001312227200850293372, 1e-12, "Apco13", "bpn(1,3)", ref status);
            Vvd(astrom.bpn[1, 0], -0.1136336652812486604e-7, 1e-12, "Apco13", "bpn(2,1)", ref status);
            Vvd(astrom.bpn[1, 1], 0.9999999995713154865, 1e-12, "Apco13", "bpn(2,2)", ref status);
            Vvd(astrom.bpn[1, 2], -0.2928086230975367296e-4, 1e-12, "Apco13", "bpn(2,3)", ref status);
            ...
            // Additional ASTROM structure checks
            ...
            // Check the equation of the origins
