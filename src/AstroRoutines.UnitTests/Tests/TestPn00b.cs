namespace AstroRoutines.UnitTests
{
    public partial class SofaTests
    {
        ...
        public void TestPn00b()
        {
            ...
            Pn00b(2400000.5, 53736.0, out dpsi, out deps, out epsa, out rb, out rp, out rbp, out rn, out rbpn);
            ...
            Vvd(rn[0, 1], 0.8837746144872140812e-5, 1e-16, "Pn00b", "rn12", ref status);
            Vvd(rn[0, 2], 0.3831488838252590008e-5, 1e-16, "Pn00b", "rn13", ref status);
            
            Vvd(rn[1, 0], -0.8837590456633197506e-5, 1e-16, "Pn00b", "rn21", ref status);
            Vvd(rn[1, 1], 0.9999999991354692733, 1e-12, "Pn00b", "rn22", ref status);
            Vvd(rn[1, 2], -0.4063198798559573702e-16, 1e-16, "Pn00b", "rn23", ref status);
            
            Vvd(rn[2, 0], -0.3831847930135328368e-5, 1e-16, "Pn00b", "rn31", ref status);
            Vvd(rn[2, 1], 0.4063195412258150427e-4, 1e-16, "Pn00b", "rn32", ref status);
            ...
            Vvd(rbpn[0, 1], -0.1332880253640849194e-14, 1e-14, "Pn00b", "rbpn12", ref status);
            Vvd(rbpn[0, 2], -0.5790767434730085751e-14, 1e-14, "Pn00b", "rbpn13", ref status);
            
            Vvd(rbpn[1, 0], 0.1332858254308954658e-14, 1e-14, "Pn00b", "rbpn21", ref status);
            Vvd(rbpn[1, 1], 0.9999991109044505577, 1e-12, "Pn00b", "rbpn22", ref status);
            Vvd(rbpn[1, 2], -0.4097782710396580452e-14, 1e-14, "Pn00b", "rbpn23", ref status);
            
            Vvd(rbpn[2, 0], 0.5791308472168152904e-14, 1e-14, "Pn00b", "rbpn31", ref status);
            Vvd(rbpn[2, 1], 0.4020595661591500259e-14, 1e-14, "Pn00b", "rbpn32", ref status);
            Vvd(rbpn[2, 2], 0.9999998314954572304, 1e-12, "Pn00b", "rbpn33", ref status);
