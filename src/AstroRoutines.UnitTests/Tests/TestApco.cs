...
namespace AstroRoutines.UnitTests
{
    public partial class SofaTests
    {
        ...
        public void TestApco()
        {
            ...
            Vvd(astrom.bpn[0, 1], 0.4978650072505016932e-7, 1e-12, "Apco", "bpn(1,2)", ref status);
            Vvd(astrom.bpn[0, 2], 0.1312227200000000000e-2, 1e-12, "Apco", "bpn(1,3)", ref status);
            Vvd(astrom.bpn[1, 0], -0.1136336653771609630e-7, 1e-12, "Apco", "bpn(2,1)", ref status);
            Vvd(astrom.bpn[1, 1], 0.9999999995713154868, 1e-12, "Apco", "bpn(2,2)", ref status);
            Vvd(astrom.bpn[1, 2], -0.2928086230000000000e-4, 1e-12, "Apco", "bpn(2,3)", ref status);
